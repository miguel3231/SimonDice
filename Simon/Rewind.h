...
namespace Simon {
	...
	/// Summary for Rewind
	/// </summary>
	public ref class Rewind : public System::Windows::Forms::Form
	{
	public:
		Rewind(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Location = System::Drawing::Point(245, 128);
			...
			this->button3->Location = System::Drawing::Point(176, 190);
			...
			this->button1->Location = System::Drawing::Point(176, 128);
			...
			this->label1->Text = L"Simon en Reversa";
			// 
			// Rewind
			// 
