...
namespace Simon {
	...
	/// <summary>
	/// Summary for Surprise2
	/// </summary>
	public ref class Surprise2 : public System::Windows::Forms::Form
	{
	public:
		Surprise2(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(114, 33);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(270, 25);
			this->label1->TabIndex = 3;
			this->label1->Text = L"Simon Sorpresa - Avanzado";
			this->label1->Click += gcnew System::EventHandler(this, &Surprise2::label1_Click);
			// 
			// Surprise2
			// 
			...
			this->Name = L"Surprise2";
			this->Text = L"Surprise2";
			this->Load += gcnew System::EventHandler(this, &Surprise2::Surprise2_Load);
...
private: System::Void Surprise2_Load(System::Object^  sender, System::EventArgs^  e) {
}
};
}
